...
По умолчанию плагин использует уровень B1, но не выбирает заметку со словами и не запускает упражнения. В **Settings → Translation Trainer** начните вводить название Markdown-заметки и выберите её из подсказок. Там же можно изменить секцию заметки, CEFR, режим расписания, часы тишины, интервалы и дневной лимит, URL endpoint, модель, таймаут и API key, а также проверить подключение, переиндексировать слова и посмотреть диагностику распознанного словаря.
