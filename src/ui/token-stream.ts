...
const TOKEN_VARIANTS: readonly (readonly string[])[] = [
	['Сопоставляю', 'Проверяю', 'Уточняю'],
	['смысл', 'значение', 'контекст'],
	['исходной', 'заданной', 'русской'],
	['фразы,', 'мысли,', 'реплики,'],
	['проверяю', 'сверяю', 'анализирую'],
	['грамматические', 'синтаксические', 'языковые'],
	['связи', 'формы', 'конструкции'],
	['и', 'затем', 'после этого'],
	['оцениваю', 'подбираю', 'уточняю'],
	['естественность', 'точность', 'выразительность'],
	['английского', 'целевого', 'итогового'],
	['варианта.', 'перевода.', 'ответа.'],
];
